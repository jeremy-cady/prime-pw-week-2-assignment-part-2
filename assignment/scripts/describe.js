...
// We then write a conditional that says if the varibale "name" has the string value
// of Mary, the computer should console.log the phrase "Hi, Mary!". Otherwise the computer
// should console.log the phrase "How do you do?". In this case, since the variable "name"
// has the value of "Dane" the computer will console.log the phrase "How do you do?".
